            ...
            <table class="highlight">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                        <a href="" class="btn waves-effect waves-red red accent-4">Ver</a>
                        </td>
                        <td>
                        <a href="{{route('torneo.edit',$torneo->id)}}" class="btn waves-effect waves-red red accent-4"> Editar</a>
                        </td>
                </tr>
                @endforeach       			
              </tbody>
