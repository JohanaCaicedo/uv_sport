      ...
      <br><br>
        ...
        <div class="col s12 m12 l12 xl12">
          <div class="card">
            ...
            <br><br>
            {!! Form::open(['route' =>  ['torneo.update', $torneo], 'method' => 'PUT', 'class'=> 'container']) !!}
            {{ csrf_field() }}

            <header><h4>Editar Torneo</h4></header> 
              <div class="row">

              <div class="input-field col s4 m4 l4 xl4">
              {!! Form::label('fecha', 'Fecha') !!} 
               {!! Form::date('fecha', $torneo->fecha, ['class' => 'form-control', 'required']) !!}  
              </div>

              <div class="input-field col s4 m4 l8 xl8">
                <label>Nombre</label>
           {!! Form::label('nombre', 'Nombre') !!}
         {!! Form::text('nombre',$torneo->nombre, ['class' => 'form-control', 'required']) !!}
              </div> 
