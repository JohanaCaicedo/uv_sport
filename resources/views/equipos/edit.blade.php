      ...
      <br><br>
        ...
        <div class="col s12 m12 l12 xl12">
          <div class="card">
            ...
            <br><br>
              {!! Form::open(['route' =>  ['equipo.update', $equipo], 'method' => 'PUT', 'class'=> 'container']) !!}
            {{ csrf_field() }}


            <header><h4>Editar Equipo</h4></header> 
              <div class="row">
              ...
              {!! Form::label('fecha', 'Fecha') !!} 
               {!! Form::date('fecha', $equipo->fecha, ['class' => 'form-control', 'required']) !!}      
              </div>

           <div class="input-field col s4 m4 l3 x3">
          {!! Form::label('deporte', 'Deporte') !!}
         {!! Form::text('deporte', $equipo->deporte, ['class' => 'form-control', 'required']) !!}
        </div>
