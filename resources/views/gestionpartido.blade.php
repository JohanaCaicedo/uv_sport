    		...
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-5">
        			<div class="card-content ">
          				<span class="card-title">Crear partidos</span>
          				<p>Listado de partidos creados, puede editar la información accediendo a esta opción.</p>
        			</div>
        			<div class="card-action">
          				<a href="{{ route('partido.create')}}">Clic aquí</a>
        			</div>
      			</div>
    		</div>
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-1">
        			<div class="card-content white-text">
          				<span class="card-title">Ver partidos</span>
          				<p>Listado de partidos registrados, puede editar la información accediendo a esta opción.</p>
        			</div>
        			<div class="card-action">
          				<a href="{{ route('partido.index')}}">Clic aquí</a>
        			</div>
      			</div>
            <br>
    		</div>
