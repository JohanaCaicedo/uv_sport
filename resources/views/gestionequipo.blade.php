    		...
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-5">
        			<div class="card-content ">
          				<span class="card-title">Ver equipos</span>
          				<p>Listado de equipos creados, puede editar la información accediendo a esta opción.</p>
        			</div>
        			<div class="card-action">
          				<a href="{{ route('equipo.index')}}">Clic aquí</a>
        			</div>
      			</div>
    		</div>
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-1">
        			<div class="card-content white-text">
          				<span class="card-title">Ver integrantes</span>
          				<p>Listado de integrantes registrados, puede editar la información accediendo a esta opción.</p>
        			</div>
        			<div class="card-action">
          				<a href="{{ route('integrante.index')}}">Clic aquí</a>
        			</div>
      			</div>
            <br>
    		</div>
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-1">
        			<div class="card-content white-text">
          				...
          				<p>Opción de registro de un nuevo equipo.</p>
        			</div>
        			<div class="card-action">
          				<a href="{{ route('equipo.create')}}">Clic aquí</a>
        			</div>
      			</div>
    		</div>
    		<div class="col s12 m12 l6 xl6">
      			<div class="card red lighten-5">
        			<div class="card-content">
          				<span class="card-title">Crear integrantes</span>
          				<p>Opción de registro de un nuevo integrante.</p>
        			</div>
        			<div class="card-action">
          			<a href="{{ route('integrante.create')}}">Clic aquí</a>
        			</div>
      			</div>
    		</div>
  		</div>
