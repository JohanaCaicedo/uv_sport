	...
	<div class="container">
      ...
      <br><br>
        ...
        <div class="col s12 m12 l12 xl12">
          ...
          {!! Form::open(['route' => 'partido.store', 'method' => 'POST', 'class'=> 'container']) !!}
            {{ csrf_field() }}

            <header><h4>Crear Partido</h4></header> 
            <div class="row">
           ...
           <div class="input-field col s4 m4 l2 xl2">
               {!! Form::label('marcador_local', 'Marcador Local') !!}
               {!! Form::text('marcador_local', null, ['class' => 'form-control', 'required']) !!}
              </div>
              <br><br><br><br>
