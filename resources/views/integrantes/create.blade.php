...
<div class="row">
        <div class="col s12 m12 l12 xl12">
          <div class="card">
            ...
            {!! Form::open(['route' => 'integrante.store', 'method' => 'POST', 'class'=> 'container']) !!}
            {{ csrf_field() }}
          

            <header><h4>Crear Integrante</h4></header> 
              <div class="row">
               ...
               {!! Form::text('plan', null, ['class' => 'form-control', 'required']) !!}
              </div>
          ...
          <div class="links">
        {!! Form::open(['route' => 'import-excel','file'=> 'true', 'method' => 'POST', 'class'=> 'container', 'enctype'=> 'multipart/form-data' , 'class'=> 'container']) !!}
            {{ csrf_field() }}
            has dd($request)
          <header><h4>Subir Archivo</h4></header> 
          {!! Form::file('excel', null, ['class' => 'form-control', 'required']) !!}
   <br><br>
        {!! Form::submit('Importar', ['class' => 'btn waves-effect waves-red red accent-4']) !!}
        {!!Form::close()!!} 
</div>
            <br><br>
